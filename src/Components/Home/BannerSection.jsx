...
const BannerSection = () => {
  ...
  const sliders = [{img: "https://i.ibb.co/mRScMYy/coffee-latte-LIB0-TB3-A8-K.jpg", title: "Escape 1", des: "A Symphony of Tranquility. Experience the perfect blend of relaxation and excitement."}, {img: "https://i.ibb.co/pRhrR8d/cup-coffee-table-against-black-background-1048944-30573805.jpg", title: "Escape 2", des: "A Symphony of Tranquility. Experience the perfect blend of relaxation and excitement."}, {img: "https://i.ibb.co/QPGQ2LN/top-view-tasty-espresso-served-cup-with-coffee-24972-2309.jpg", title: "Escape 3", des: "A Symphony of Tranquility. Experience the perfect blend of relaxation and excitement."}, {img: "https://i.ibb.co/tYsXcYv/top-view-coffee-cup-coffee-beans-dark-table-176474-560.jpg", title: "Escape 4", des: "A Symphony of Tranquility. Experience the perfect blend of relaxation and excitement."}, {img: "https://i.ibb.co/C8Dn3DP/top-view-cup-surrounded-by-coffee-beans-23-2148336809.jpg", title: "Escape 5", des: "A Symphony of Tranquility. Experience the perfect blend of relaxation and excitement."},];
  ...
  const isSmallScreen = window.innerWidth <= 768;
    return (
        <div>
            <div className="w-full h-96 sm:h-60 md:h-[650px] flex flex-col xl:flex-row items-center justify-center gap-5 lg:gap-10 relative bg-cover before:absolute before:bg-black/50 before:inset-0 transform duration-1000 ease-linear z-50 overflow-hidden py-24"
            ...
            <div className="absolute bottom-1/4 flex gap-3 z-50 px-5">
                {/* arrow left */}
                <button onClick={prevSlider} className="flex justify-center items-center hover:bg-white/30 rounded-full w-6 h-6 md:w-12 md:h-8">
                ...
                <div className="ease-linear duration-300 flex gap-4 items-center"
                    ...
                    {sliders.map((slide, inx) => (
                        <img key={inx} src={slide.img}
                            className={`h-[180px] sm:h-[200px] lg:h-[180px] min-w-[90px] lg:min-w-[254px] ${
